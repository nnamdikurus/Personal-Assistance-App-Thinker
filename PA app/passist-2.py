...
frame_rem = LabelFrame(tab_rem, bg = "#37dedb", bd = 3,padx = 10, pady = 50)
...
def tick():
	...
	lblInfo.config(text = (mytime +"\t" + "\t" + mydate))
	lblInfo.after(200,tick)
lblInfo = Label(tab_rem, font = "arial 20 bold", fg = "dark blue", bg = "#d4b09b")
...
frame_pres = LabelFrame(tab_pres, bd = 4, bg = "#BDBDBD",relief = SUNKEN, pady = 10)
...
tree_pres.column("#0", width = 40, anchor = "n")

tree_pres.heading("#1", text = "Presentation Topic")
tree_pres.column("#1", width = 220, anchor = "n")

tree_pres.heading("#2", text = "Created By")
tree_pres.column("#2", width = 150, anchor = "n")

tree_pres.heading("#3", text = "Date Presented")
tree_pres.column("#3", width = 130, anchor = "n")

tree_pres.heading("#4", text = "Time")
tree_pres.column("#4", width = 80, anchor = "n")
...
scroll_pres.grid(row = 3, column = 0, columnspan = 10, padx=(320,0), rowspan = 3, sticky = NS)
...
frame_label_ms = LabelFrame(tab_meet, padx = 5, pady = 10, bg = "#7f9494", width = 20, height= 20, relief = SUNKEN)
